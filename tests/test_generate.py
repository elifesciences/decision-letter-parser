...
def simple_author_response():
    ...
    disp_quote_block.content_blocks.append(
        ContentBlock("p", "1) I am not sure that I understand ....")
    )
...
class TestGenerateArticlesForTables(unittest.TestCase):
    def test_generate_table_35684(self):
        ...
        table_wrap_blocks = [
            block
            for block in articles[1].content_blocks
            if block.block_type == "table-wrap"
        ]
        self.assertEqual(len(table_wrap_blocks), 4)
        self.assertTrue(
            table_wrap_blocks[0].content.startswith(
...
class TestXmlStringAssetXref(unittest.TestCase):
    @data(
        {
            "xml_string": ("<p>In Author response image 1, yes.</p>"),
            "asset_labels": [
                OrderedDict(
                    [
                        ("id", "sa2fig1"),
        ...
        {
            "xml_string": ("<p>In the figure (Author response image 1B), a yes.</p>"),
            "asset_labels": [
                OrderedDict(
                    [
                        ("id", "sa2fig1"),
        ...
        {
            "xml_string": ("<p>In Author response image 1A-D, also yes.</p>"),
            "asset_labels": [
                OrderedDict(
                    [
                        ("id", "sa2fig1"),
        ...
        {
            "xml_string": ("<p>Author response image 1A</p>"),
            "asset_labels": [
                OrderedDict([("id", "sa2fig1"), ("type", "fig"), ("text", "")])
            ],
            "expected": ("<p>Author response image 1A</p>"),
        },
    )
